...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.6\columnwidth]{../images/sse_silhouette_vs_k.png}
...
\includegraphics[height=0.6\columnwidth]{../images/k-centroids_analysis.png}
...
\begin{subfigure}{.33\textwidth}
  \centering
  \includegraphics[width=1\textwidth]{../images/kde_quantitative_features.png}
  \label{fig:kde_dataset}
\end{subfigure}%
\begin{subfigure}{.33\textwidth}
  \centering
  \includegraphics[width=1\textwidth]{../images/kde_within_clusters_c4.png}
  \label{fig:kde_4}
\end{subfigure}
\begin{subfigure}{.33\textwidth}
  \centering
...
\begin{figure}[hbtp]
\centering 
\includegraphics[width=0.5\columnwidth]{../images/pca_kmeans.png}
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.5\columnwidth]{../images/dbscan_epsilon_selection.png}
